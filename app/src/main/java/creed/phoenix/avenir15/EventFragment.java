...
public class EventFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mListView.setAdapter(new PaintingsAdapter(getActivity().getApplicationContext(),allocatedpos));
    ...
    public void openDetails(View coverView, final Painting painting) {
        ...
        Picasso.with(getActivity().getApplicationContext()).load(painting.getImageId()).into(image);
        ...
        description.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogBuilder
                        .withTitle(painting.getTitle())                                  //.withTitle(null)  no title
                        ...
                        .setCustomView(painting.getYear(), getActivity().getApplicationContext())         //.setCustomView(View or ResId,context)
